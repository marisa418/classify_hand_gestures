...
sos = signal.iirfilter(10, [50, 400], rs=150, btype='band',
...
ax2.plot(xf,1.0/N * np.abs(yplot0) , 'r-')
...
ax1.set_ylabel('Emg Signal')
ax1.set_xlabel('Sample')
ax2.plot(xf,1.0/N * np.abs(yplot5), 'r-')
ax2.set_ylabel('Spectral Density')
ax2.set_xlabel('Frequency')
...
ax1.set_ylabel('Emg Signal')
ax1.set_xlabel('Sample')
ax2.plot(xf,1.0/N * np.abs(yplot4), 'r-')
ax2.set_ylabel('Spectral Density')
ax2.set_xlabel('Frequency')
...
ax1.set_ylabel('Emg Signal')
ax1.set_xlabel('Sample')
ax2.plot(xf,1.0/N * np.abs(yplot3), 'r-')
ax2.set_ylabel('Spectral Density')
ax2.set_xlabel('Frequency')
...
ax1.set_ylabel('Emg Signal')
ax1.set_xlabel('Sample')
ax2.plot(xf,1.0/N * np.abs(yplot2), 'r-')
ax2.set_ylabel('Spectral Density')
ax2.set_xlabel('Frequency')
...
ax1.set_ylabel('Emg Signal')
ax1.set_xlabel('Sample')
ax2.plot(xf,1.0/N * np.abs(yplot1), 'r-')
ax2.set_ylabel('Spectral Density')
ax2.set_xlabel('Frequency')
...
ax1.plot(F3,label='Filter 50-500 Hz')
